...
ActiveRecord::Schema.define(version: 2021_11_13_192000) do
  ...
  create_table "book_lends", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_book_lends_on_user_id"
  end
  ...
  add_foreign_key "book_lends", "books"
  add_foreign_key "book_lends", "users"
